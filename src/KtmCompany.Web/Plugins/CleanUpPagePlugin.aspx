<%@ Page Language="c#" Codebehind="CleanUpPagePlugin.aspx.cs" AutoEventWireup="true" Inherits="KtmCompany.Web.Plugins.CleanUpPagePlugin" Title="" EnableViewState="true"%>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:DropDownList runat="server" ID="ddlChooseCleanUpActionType" AutoPostBack="True" OnSelectedIndexChanged="ddlChooseCleanUpActionType_OnSelectedIndexChanged" />
            <br />
