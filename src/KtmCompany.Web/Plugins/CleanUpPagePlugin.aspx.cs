...
namespace KtmCompany.Web.Plugins
{
    [GuiPlugIn(DisplayName = "Clean up page", Description = "This is used for cleaning up unused pages and unused properties", Area = PlugInArea.AdminMenu, 
        Url = "/Plugins/CleanUpPagePlugin.aspx")]
    public partial class CleanUpPagePlugin : Page
    {
        ...
        protected void ddlChooseCleanUpActionType_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            BindData();
        }
    }
